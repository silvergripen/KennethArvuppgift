...
namespace KennethArvuppgift
{
    class Get : Djur
    {
        public Get(string pupilShape, string sounds, string animalType, bool fur, bool carnivore, bool omnivore, bool subtype) : base(pupilShape, sounds, animalType, fur, carnivore,omnivore, subtype)
            {
